...
public class StatisticsController {
    ...
    public Integer getCommentsByPost(@RequestParam(required = false, defaultValue = "0") @Parameter Integer postId) {
    ...
    public Integer getDialogsUser(@RequestParam(required = false, defaultValue = "0") @Parameter Integer userId) {
    ...
    public Integer getLikeEntity(@RequestParam(required = false, defaultValue = "0") @Parameter Integer entityId) {
    ...
    public TreeMap<String, Integer> getMessage(@RequestParam(required = false, defaultValue = "0") @Parameter Integer firstUserId,
                                               @RequestParam(required = false, defaultValue = "0") @Parameter Integer secondUserId) {
    ...
    public Integer getMessageByDialog(@RequestParam(required = false, defaultValue = "0") @Parameter Integer dialogId) {
    ...
    public Integer getAllPostByUser(@RequestParam(required = false, defaultValue = "0") @Parameter Integer userId) {
    ...
    public Integer getTagsByPost(@RequestParam(required = false, defaultValue = "0") @Parameter Integer postId) {
    ...
    public Integer getAllUsersByCity(@RequestParam(required = false, defaultValue = "") @Parameter String city) {
    ...
    public Integer getAllUsersByCountry(@RequestParam(required = false, defaultValue = "") @Parameter String country) {
