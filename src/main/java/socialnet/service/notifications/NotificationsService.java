...
public class NotificationsService {
    ...
    public CommonRs<List<NotificationRs>> getAllNotification(Integer itemPerPage,String token,Integer offset){
        ...
        if (personsEmail == null) {
            ...
            PersonRs personRs = personMapper.toDTO(personsEmail.get(0));
